                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="stuid" class="form-control" placeholder="633410000-0" maxlength="11">
                            @error('stuid')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <strong>Name</strong>
                            <input type="text" name="name" class="form-control" placeholder="Kawinphop Chs.">
                            @error('name')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="lastname" class="form-control" placeholder="Chomnikorn">
                            @error('lastname')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
